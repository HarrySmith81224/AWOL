    ...
    <>
      ...
      >
        ...
        <div className="space-x-4">
          ...
          <button
            type="submit"
            className="bg-secondary text-textColor py-2 px-4 hover:bg-textColor hover:text-white text-[14px]"
          >
            Search
          </button>
        </div>
      ...
      >
        <div className="sticky top-0 bg-primary py-4 w-[100%]">
          ...
          <Link
            ...
            onClick={() => setIsOpen(false)}
          >
            <div className="sidebarTitle text-[28px] text-center">AWOL</div>
          </Link>
        </div>
        ...
        <div className="px-4 pb-16">
          ...
          <div className="flex flex-col  gap-4 pt-4">
            <p className="sidbarTitle">Genres</p>
