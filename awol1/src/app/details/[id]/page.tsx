...
const MovieDetails = () => {
  ...
  return (
    <main
      className="bg-secondary p-8 relative max-h-[calc(100vh-77px)] min-h-[calc(100vh-77px)] overflow-y-scroll scrollbar-thin
    ...
    >
      ...
      <div className="flex justify-center items-center pt-4 md:pt-0">
        <div className="grid md:grid-cols-[300px,1fr] max-w-[1200px] gap-12">
          ...
          <div className="space-y-6 md:space-y-3 text-textColor">
            ...
            <div className="flex flex-col md:flow-row gap-2 md:gap-6">
      ...
      >
        <div className="flex items-center justify-between bg-black text-[#f9f9f9] p-3.5">
          ...
          <div
            className="curser-pointer w-8 h-8 flex justify-center items-center rounded-lg opacity-50 hover:opacity-75 hover:bg-[#0f0f0f]"
